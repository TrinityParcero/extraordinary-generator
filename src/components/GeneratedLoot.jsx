...
class GeneratedLoot extends React.Component{
    ...
    render(){
        ...
        let nameElement = <a href={this.item.link} target="_blank" rel="noreferrer"><h2>{displayName}</h2></a>;
        if(displayName.length > 20){
            nameElement = <a href={this.item.link} target="_blank" rel="noreferrer"><h2 className="longString">{displayName}</h2></a>
        }
     return(
